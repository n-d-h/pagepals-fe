...
import { getListCustomerAndListAccountState } from '../../../services/apolo/queries';
...
export default function UserListView () {
  ...
  const setDataFetching = (data) => {
    setTableData(data.getListCustomer);
  ...
  const { loading, error } = useQuery(getListCustomerAndListAccountState, {
