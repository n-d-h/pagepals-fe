...
export default function BankingWidgetSummaryToken({
  title,
  total,
  icon,
  percent,
  ...
  return (
    ...
    >
      ...
      <Stack spacing={1} sx={{ p: 3 }}>
        ...
        <Typography variant="h3">{total + ' pals'}</Typography>
...
BankingWidgetSummaryToken.propTypes = {
